...
const scenes = {
  ...
  // =========================================================
  // DAY 1
  // MARKET SIGNALS + CONSULTATIVE SELLING
  ...
  scene1: {
    type: "text",
    text: `
DAY 1 — BACK TO BUSINESS

September changes the rhythm of sales.

Clients return.
Projects restart.
Budgets come back into focus.
Accounts that appeared quiet in August may suddenly become active.

Imagine that you are reviewing your regional territory after the summer.

Discuss:

• Which accounts would you check first?
• What information would you want before contacting them?
• What may have changed during August?
• Which is more useful: knowing that a company is growing, or understanding why it is growing?
    `,
    choices: [
      {
        text: "Look at the market",
        next: "scene2"
      }
    ]
  },
...
1. What happened to overall activity?
2. What happened to demand?
3. Which markets performed relatively strongly?
4. Which signals might matter to a regional B2B sales team?
    ...
    choices: [
      {
        ...
        url: "https://www.reuters.com/world/europe/euro-zone-overall-business-growth-held-steady-august-pmi-shows-2026-09-03/"
      },
      {
        text: "Continue",
        next: "scene3"
...
"Business activity is holding up, so we should increase the regional forecast."

Which response is the most commercially defensible?
    `,
    choices: [
      {
        text: "Yes. Stronger macroeconomic figures mean individual customers are more likely to buy.",
        next: "scene3_retry"
      },
      {
        text: "No. External economic information is irrelevant to B2B sales decisions.",
        next: "scene3_retry"
      },
      {
        text: "Not necessarily. The figures may improve the outlook, but account-level evidence is still needed before changing priorities.",
        next: "scene4"
      }
    ]
  },
...
MARKET SIGNAL ≠ QUALIFIED OPPORTUNITY

External information can help identify where to look.

It cannot replace evidence about:
...
• and the decision process.
  ...
  scene4: {
    ...
    text: "Complete the regional sales briefing.",
    sentence: [
      "Recent figures point ",
      "__________",
      " relatively resilient business activity. The team has therefore started a more detailed pipeline ",
      "__________",
      ". Several previously quiet accounts have ",
      "__________",
      " signs of renewed activity, but each opportunity still needs to be properly ",
      "__________",
      " before we change our commercial ",
      "__________",
      "."
    ],
    blanks: [1, 3, 5, 7, 9],
  ...
  scene5: {
    type: "hangman",
    noSpeechUI: true,
    hint: "Sales: the collection of active opportunities that may generate future revenue.",
    target: "pipeline",
    maxWrong: 6,
    allowRetry: false,
    suppressHub: true,
    next: "scene5_remedial",
    onLoseNext: "scene5_remedial"
  },
...
The pipeline is the collection of opportunities currently moving through the sales process.
...
Use PAST SIMPLE with finished time:

• We contacted the account last week.
• Sales increased in August.
• The client postponed the meeting yesterday.

Use PRESENT PERFECT when the development connects with now:

• We have seen stronger demand since July.
• Several dormant accounts have become active again.
...
→ Present perfect
  ...
  scene7: {
    type: "fill-in-the-blank",
    text: "Complete the pipeline update.",
    sentence: [
      "We ",
      "__________",
      " three opportunities in August. Since the beginning of September, however, two new prospects ",
      "__________",
      " the pipeline. One existing client ",
      "__________",
      " additional information yesterday, and the sales team ",
      "__________",
      " already ",
      "__________",
      " a follow-up meeting."
  ...
  scene8: {
    type: "scramble",
    text: `
Rebuild the regional update.

Use the time references to guide the order.
    `,
    scramble: [
      "but activity has strengthened since the beginning of September",
      "and we have already identified two accounts requiring immediate follow-up",
      "Several opportunities remained inactive during August",
      "which means our priorities may need to change",
      "The team reviewed the regional pipeline yesterday"
    ],
    correct: [
      "The team reviewed the regional pipeline yesterday",
      "Several opportunities remained inactive during August",
  ...
  scene9: {
    ...
    youtube: "https://www.youtube.com/watch?v=9SttslsLiTQ",
...
• creating longer-term commercial value.
...
Then answer the questions.
    ...
    questions: [
      {
        text: "What is the central difference between consultative selling and a purely transactional approach?",
        options: [
          "Consultative selling focuses more heavily on discounting.",
          "Consultative selling seeks to understand the client's situation before proposing value.",
          "Consultative selling avoids discussing commercial objectives.",
          "Consultative selling is mainly designed for small consumer purchases."
        ],
        correct: 1
      },
      {
        text: "Why can a relationship-based approach be particularly valuable in B2B sales?",
        options: [
          "Because complex business decisions often require trust and an understanding of longer-term needs.",
          "Because B2B customers generally make decisions without comparing alternatives.",
          "Because relationships eliminate the need to demonstrate value.",
          "Because price becomes irrelevant once rapport has been established."
        ],
        correct: 0
      },
      {
        text: "Which behaviour best reflects a consultative approach?",
        options: [
          "Presenting all product features before asking questions.",
          "Immediately asking how much budget is available.",
          "Exploring how the client currently works and where difficulties or opportunities exist.",
          "Assuming that a senior contact is automatically the decision-maker."
        ],
        correct: 2
      }
    ],
...
Consultative selling begins with the customer's situation.

The product comes later.

Watch again with that distinction in mind.
    `,
    choices: [
      {
        text: "Watch again",
...
"We already have access to company information, so I'm not sure we need anything else."

Which response creates the strongest consultative conversation?
    `,
    choices: [
      {
        text: "Are you sure the information you currently use is reliable enough?",
        next: "scene10_retry"
      },
      {
        text: "How are you currently using that information when deciding which customers or suppliers deserve closer attention?",
        next: "scene11"
      },
      {
        text: "Would you like me to explain all of the solutions we offer?",
        next: "scene10_retry"
      },
      {
        text: "How much budget do you have available?",
        next: "scene10_retry"
      }
    ]
  },
  ...
  scene10_retry: {
    type: "text",
    text: `
A consultative question should uncover:
...
Build the current-development sentence.
    `,
    scramble: [
      "stronger",
      "September",
...
Use the finished-time reference correctly.
    `,
    scramble: [
      "three",
      "last",
...
Build the current-result sentence.
    `,
    scramble: [
      "already",
      "The",
...
Contrast a finished period with a development connected to now.
    `,
    scramble: [
      "active",
      "August",
...
Write a concise internal regional sales update.

Approximately 90–120 words.

Situation:

You have reviewed the pipeline after the summer.

Some accounts were inactive in August, but several have shown renewed activity since September.

Include:

• one finished event from August;
• two developments connected with the present;
• one account or segment deserving attention;
...
business need
    ...
    emailSubject: "Regional pipeline update",
    emailBody: "",
    next: "scene16"
  },
...
PRESENT PERFECT
for developments connected with now.

DAY 2:

Not every opportunity deserves the same attention.
...
A large opportunity is not necessarily the best opportunity.

Discuss:

• What makes one prospect more valuable than another?
• Is urgency more important than potential contract value?
• How important is access to the real decision-maker?
• When should a salesperson stop pursuing an opportunity?
• Which accounts deserve more management attention?
    `,
    choices: [
      {
        text: "Look at today's market signal",
        next: "scene18"
      }
    ]
  },
...
"Euro zone investor morale hits four-year-plus high in September"

While reading, identify:

1. What changed?
2. What happened to expectations?
3. Does confidence guarantee spending?
4. Could improving sentiment justify contacting some accounts earlier than planned?
5. What additional evidence would you need?
    `,
    choices: [
      {
        text: "Open Reuters article",
        url: "https://www.reuters.com/world/europe/euro-zone-investor-morale-hits-four-year-plus-high-september-sentix-survey-shows-2026-09-07/"
      },
      {
        text: "Continue",
        next: "scene19"
...
Which response is the strongest commercial interpretation?
    `,
    choices: [
      {
        text: "All prospects should now be considered more likely to buy.",
        next: "scene19_retry"
      },
      {
        text: "The signal may justify reviewing some accounts sooner, but customer-level evidence is still necessary.",
        next: "scene20"
      },
      {
        text: "Investor confidence should never influence account prioritisation.",
        next: "scene19_retry"
      }
    ]
  },
  ...
  scene19_retry: {
    type: "text",
    text: `
Market confidence may influence timing and opportunity.

But it does not tell us:

• whether the customer has a problem;
• whether the problem is urgent;
• who decides;
• whether budget exists;
• or what happens next.

External signal + account evidence = better prioritisation.
    `,
    choices: [
      {
        text: "Try again",
  ...
  scene20: {
    type: "fill-in-the-blank",
    text: "Complete the opportunity review.",
    sentence: [
      "Account A is currently ",
      "__________",
      " advanced than Account B because the decision-maker has been identified. Account B has greater potential ",
      "__________",
      ", but the level of urgency remains ",
      "__________",
      ". The team should therefore ",
      "__________",
      " both opportunities before deciding where to ",
      "__________",
  ...
  scene21: {
    type: "hangman",
    noSpeechUI: true,
    hint: "Sales: the process of deciding whether a prospect has enough need, fit, authority, budget and timing to justify further pursuit.",
    target: "qualification",
    maxWrong: 6,
    allowRetry: false,
    suppressHub: true,
    next: "scene21_remedial",
    onLoseNext: "scene21_remedial"
  },
...
Qualification determines whether an opportunity deserves further time and resources.
...
Interest alone is not qualification.
    `,
    choices: [
      {
        text: "Continue",
...
Comparatives allow sales leaders to rank opportunities:

• Account A is more advanced than Account B.
• Account B is less urgent than Account C.
• This opportunity is stronger than it was last month.
• Account C has the highest potential value.

Modals calibrate judgment:
...
"We should contact Account A first."

"Account B might become more important next month."

"We must identify the decision-maker before increasing our confidence."
    `,
    choices: [
      {
        text: "Apply it",
 ...
 scene23: {
  type: "fill-in-the-blank",
  text: "Complete the prioritisation discussion.",
  sentence: [
    "Account A is ",
    "__________",
    " advanced than Account B, but Account B could become increasingly ",
    "__________",
    " if urgency increases. We ",
    "__________",
    " therefore investigate the decision process before allocating additional resources. Account C ",
    "__________",
    " also deserve attention, although it is currently less qualified ",
    "__________",
    " Account A."
  ],
  blanks: [1, 3, 5, 7, 9],
  ...
  scene24: {
    type: "scramble",
    text: `
Build the management recommendation.

Evidence should come before priority.
    `,
    scramble: [
      "while Account B may deserve more attention if urgency increases",
      "Account A is currently the more qualified opportunity",
      "so the team should protect the next confirmed step",
      "rather than allocating resources purely according to potential deal size",
      "because budget authority and timing are clearer"
    ],
    correct: [
      "Account A is currently the more qualified opportunity",
      "because budget authority and timing are clearer",
  ...
  scene25: {
    type: "video-multi-question",
    youtube: "https://www.youtube.com/watch?v=jvIA20qP4N4",

    text: `
RULES FOR CONSULTATIVE SALES

Dave Lorenzo

Watch the English-language video.

Listen especially for ideas connected with:
...
Think about how those factors help a sales manager decide whether an opportunity deserves more attention.
    `,
    ...
    questions: [
      {
        text: "Why is urgency important when assessing an opportunity?",
        options: [
          "Because urgency helps establish whether the customer has a reason to act rather than simply an interest.",
          "Because urgent customers never negotiate on price.",
          "Because urgency proves that budget has already been approved.",
          "Because urgency makes stakeholder analysis unnecessary."
        ],
        correct: 0
      },
      {
        text: "Why should a salesperson understand the stakeholders involved?",
        options: [
          "Because every stakeholder will have exactly the same priorities.",
          "Because a deal can depend on several people with different roles in the decision.",
          "Because identifying stakeholders removes the need for a next step.",
          "Because only senior executives influence B2B purchases."
        ],
        correct: 1
      },
      {
        text: "Which situation suggests the strongest opportunity?",
        options: [
          "The customer likes the presentation but no next meeting has been agreed.",
          "The potential deal is very large but the need and decision process remain unclear.",
          "The customer has identified a meaningful outcome, relevant stakeholders and a concrete next step.",
          "The salesperson has spoken to the account several times."
        ],
        correct: 2
      }
    ],
  ...
  scene25_retry: {
    type: "text",
    text: `
Do not confuse INTEREST with PROGRESS.
...
Watch again with those five elements in mind.
    `,
    choices: [
      {
        text: "Watch again",
...
Discovery meeting next week

Which account is currently the most qualified?
    `,
    choices: [
      {
        text: "Account B — it has the highest theoretical value.",
        next: "scene26_retry"
      },
      {
        text: "Account C — it is already a customer.",
        next: "scene26_retry"
      },
      {
        text: "Account A — the need, authority, budget and next step are currently clearest.",
        next: "scene27"
      }
    ]
  },
  ...
  scene26_retry: {
    type: "text",
    text: `
Potential deal size alone is not enough.
...
Which account currently provides the strongest evidence?
    `,
    choices: [
      {
        text: "Choose again",
  ...
  scene27: {
    type: "text",
    text: `
Account A is currently the MOST QUALIFIED.

But that does not automatically mean the team should spend the most time on it.

Account B has greater potential but greater uncertainty.

Account C may offer expansion potential because a relationship already exists.

Discuss:

Which account should receive:

1. the highest forecast confidence?
2. the most immediate sales attention?
3. the most management support?

Are those necessarily the same account?
    `,
    choices: [
      {
        text: "Start Grammar Run",
        next: "scene28"
      }
    ]
  },
...
Express possibility rather than certainty.
    `,
    scramble: [
      "important",
      "become",
...
Build the comparison.
  ...
  scene32: {
    type: "fill-in-the-blank",
    awardOnEnter: 15,
    text: "Complete the final opportunity review.",
    sentence: [
      "Account A is currently ",
      "__________",
      " qualified than Account B, but Account B has ",
      "__________",
      " revenue potential. The team ",
      "__________",
      " investigate its urgency and decision process before increasing its priority. Account C ",
      "__________",
      " also develop quickly because an existing relationship is already in place, so its next meeting may be ",
      "__________",
      " important than its current deal value suggests."
    ],
    blanks: [1, 3, 5, 7, 9],
    options: [
      "should",
...
Write a 100–130 word regional sales recommendation to senior management.

Use the three-account scenario.

Explain:

• which account is currently the most qualified;
• which account may deserve additional sales attention;
• one important uncertainty;
• what the team should do next.

Use:

• at least two comparative structures;
• one SHOULD;
• one MAY / MIGHT / COULD;
• at least three items of today's vocabulary.
...
allocate resources
    `,
    teacherEmail: "xavier.benitz@gmail.com",
    emailSubject: "Regional opportunity priorities",
    emailBody: "",
    next: "scene34"
  },
...
A large opportunity is not necessarily a good opportunity.

And a good opportunity is not necessarily the one that needs the most sales attention.
    `
  }
